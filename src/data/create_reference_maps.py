...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description=(
            "Extract reference mapkeyframes as indices fromprocessed raw traverses"
        )
    )
    parser.add_argument(
        "-t",
    ...
    parser.add_argument(
        ...
        default=15,
        help=(
            "weight for attitude component of pose"
    ...
    parser.add_argument(
        ...
        type=float,
        default=0.5,
        help="threshold on weighted pose distance togenerate new keyframe",
    )
    ...
    for name in pbar:
        ...
        indices = build_reference_keyframes(
            rtk_poses, args.kf_threshold, args.attitude_weight
        )
